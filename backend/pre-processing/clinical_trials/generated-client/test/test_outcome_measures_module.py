...
class TestOutcomeMeasuresModule(unittest.TestCase):
    """OutcomeMeasuresModule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OutcomeMeasuresModule:
        """Test OutcomeMeasuresModule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OutcomeMeasuresModule`
        """
        model = OutcomeMeasuresModule()
        if include_optional:
            return OutcomeMeasuresModule(
                outcome_measures = [
    ...
    def testOutcomeMeasuresModule(self):
        """Test OutcomeMeasuresModule"""
