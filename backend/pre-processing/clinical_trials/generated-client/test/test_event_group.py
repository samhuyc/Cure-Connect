...
class TestEventGroup(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EventGroup:
        """Test EventGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventGroup`
        """
        model = EventGroup()
        if include_optional:
            return EventGroup(
