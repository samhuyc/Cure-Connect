...
class ViolationEvent(BaseModel):
    ...
    posted_date: Optional[date] = Field(default=None, alias="postedDate")
    __properties: ClassVar[List[str]] = ["type", "description", "creationDate", "issuedDate", "releaseDate", "postedDate"]
