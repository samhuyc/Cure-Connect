...
class ExpandedAccessTypes(BaseModel):
    ...
    ExpandedAccessTypes
    """ # noqa: E501
    individual: Optional[StrictBool] = None
    intermediate: Optional[StrictBool] = None
    treatment: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["individual", "intermediate", "treatment"]
