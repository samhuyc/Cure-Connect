...
class TestSubmissionTracking(unittest.TestCase):
    """SubmissionTracking unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubmissionTracking:
        """Test SubmissionTracking
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubmissionTracking`
        """
    ...
    def testSubmissionTracking(self):
        """Test SubmissionTracking"""
