...
class PagedStudies(BaseModel):
    ...
    studies: List[Study] = Field(description="`study` field values of type `markup` are in markdown format. ")
    total_count: Optional[StrictInt] = Field(default=None, alias="totalCount")
    __properties: ClassVar[List[str]] = ["nextPageToken", "studies", "totalCount"]
