...
class ParticipantFlowModule(BaseModel):
    ...
    """ # noqa: E501
    pre_assignment_details: Optional[StrictStr] = Field(default=None, alias="preAssignmentDetails")
    recruitment_details: Optional[StrictStr] = Field(default=None, alias="recruitmentDetails")
    ...
    __properties: ClassVar[List[str]] = ["preAssignmentDetails", "recruitmentDetails", "typeUnitsAnalyzed", "groups", "periods"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "preAssignmentDetails": obj.get("preAssignmentDetails"),
            "recruitmentDetails": obj.get("recruitmentDetails"),
            "typeUnitsAnalyzed": obj.get("typeUnitsAnalyzed"),
            "groups": [FlowGroup.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None,
            "periods": [FlowPeriod.from_dict(_item) for _item in obj["periods"]] if obj.get("periods") is not None else None
        })
        return _obj
