...
class DescriptionModule(BaseModel):
    ...
    DescriptionModule
    """ # noqa: E501
    brief_summary: Optional[StrictStr] = Field(default=None, alias="briefSummary")
    detailed_description: Optional[StrictStr] = Field(default=None, alias="detailedDescription")
    __properties: ClassVar[List[str]] = ["briefSummary", "detailedDescription"]
